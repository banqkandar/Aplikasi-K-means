...
<div class="container">
  <h5 class="mt-4">Data TF-IDF Dokumen 1</h5>
  <div class="row mt-3">
    <div class="col-md-3">
      <?php
      //Cluster Awal
    ...
    <div class="col-md-4">
      <table class="table table-hover">
        ...
        <tbody>
          <?php
          $i = 1;
          $array = explode("\n", file_get_contents('dokumen1.txt'));
  ...
  while ($pernyataan) {
    ...
    if ($hasil[$x - 1]['clust'] == $clust) {
      ...
      Ternyata setelah dikelompokan clusternya sama dengan yang sebelumnya, maka iterasinya dapat diberhentikan sehingga kalimat yang termasuk pada cluster 1 yaitu k2, cluster 2 yaitu k1 , k3, k4, k5, k6, k7.</div>";
    } else {
