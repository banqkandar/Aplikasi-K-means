...
<?php $pisahin  = explode(":", file_get_contents('data/cdokumen3.txt'));?>
<div class="container">
  <h5 class="mt-4">Data TF-IDF Dokumen 3</h5>
  <div class="row mt-4">
    <div class="col-md-4">
      <fieldset class="scheduler-border">
        ...
        <form action="" method="post">
          <?php 
          if($_POST['kalimat']){
           $namafile = "data/dokumen3.txt";  
           $isi      = trim($_POST['kalimat']);  
           $file = fopen($namafile,"w");  
           fwrite($file,$isi);  
           fclose($file);
           $cnamafile = "data/cdokumen3.txt";  
