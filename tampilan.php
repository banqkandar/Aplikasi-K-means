...
while ($pernyataan) {
  ...
  //menghitung jumlah data kalimat
  $jumlah = count(array_filter($kalimats));
  
  //hasil menghitung jarak
  $data = hitung_jarak($kalimats, $cc1, $cc2, $jumlah); 
  $hasil[$x]['jumlah'] = $jumlah;
  $hasil[$x]['data'] = $data;

  //cari minimum
  $clust = cluster($data, $hasil[$x]['jumlah']);
  $hasil[$x]['clust'] = $clust;
